...
#            If you want more information about SqueezeMeta, I recommend that you read up on it: https://github.com/jtamames/SqueezeMeta and
#            https://squeezemeta.readthedocs.io/en/latest/index.html


module load squeezemeta/1.6.1post1

SqueezeMeta.pl -m sequential -s Samples_IC42_1.txt -f <pathway_to_your_files>/IC42_1_res -extassembly ./IC42_1_scaffolds.fasta -binners maxbin,metabat2,concoct
